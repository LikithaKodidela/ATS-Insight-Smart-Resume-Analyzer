...
from backend.services.model_loader import load_sentence_embedder
...
async def lifespan(app:FastAPI):
    ...
    app.state.embedder, app.state.model_info = load_sentence_embedder()
    logger.info(f"Loaded embedder: {app.state.model_info}")
