...
def parse_resume(raw_text: str) -> Dict:
    """Synchronous wrapper kept for backwards-compat. Prefer parse_resume_async."""
    client = _get_client()
...
async def parse_resume_async(raw_text: str) -> Dict:
    """Run parse_resume in a thread so the async event loop is not blocked."""
    loop = asyncio.get_event_loop()
    return await loop.run_in_executor(_executor, parse_resume, raw_text)
...
def parse_job_description(raw_text: str) -> Dict:
    """Synchronous wrapper kept for backwards-compat. Prefer parse_job_description_async."""
    client = _get_client()
...
async def parse_job_description_async(raw_text: str) -> Dict:
    """Run parse_job_description in a thread so the async event loop is not blocked."""
    loop = asyncio.get_event_loop()
    return await loop.run_in_executor(_executor, parse_job_description, raw_text)
